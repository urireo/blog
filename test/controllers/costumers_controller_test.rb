...
class CostumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create costumer" do
    assert_difference('Costumer.count') do
      post costumers_url, params: { costumer: { email: @costumer.email, first_name: @costumer.first_name, last_name: @costumer.last_name, phone: @costumer.phone } }
    end
  ...
  test "should update costumer" do
    patch costumer_url(@costumer), params: { costumer: { email: @costumer.email, first_name: @costumer.first_name, last_name: @costumer.last_name, phone: @costumer.phone } }
